        ...
        {activeTab === 'general' && (
          <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-md border border-gray-200 space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 bg-sky-50/70 p-4 rounded-2xl border border-sky-200">
                <label htmlFor="developerFooterText" className="block text-sm font-black text-sky-950 mb-1">
                  نص حقوق المطور والتذييل (Footer) أسفل الموقع
                </label>
                <p className="text-xs text-sky-700 mb-2 font-medium">
                  يمكنك تعديل عبارة المطور أو إضافة أي نص تريده ليظهر في شريط التذييل أسفل جميع صفحات الموقع
                </p>
                <input
                  type="text"
                  id="developerFooterText"
                  name="developerFooterText"
                  value={localSettings.developerFooterText || ''}
                  onChange={handleLocalChange}
                  placeholder="Developer: M.K Studio — 2025"
                  className="w-full px-4 py-2.5 border-2 border-sky-300 rounded-xl focus:ring-2 focus:ring-sky-500 font-bold text-gray-800 text-sm bg-white"
                />
                <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                  <span>المعاينة المباشرة: <strong className="text-gray-800 font-black">{localSettings.developerFooterText || 'Developer: M.K Studio — 2025'}</strong></span>
                  <button
                    type="button"
                    onClick={() => setLocalSettings(prev => ({ ...prev, developerFooterText: 'Developer: M.K Studio — 2025' }))}
