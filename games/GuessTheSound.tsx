...
const SOUNDS: SoundItem[] = [
  ...
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'أسد', answer: '🦁', options: ['🦁', '🐺', '🐻'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'حصان', answer: '🐴', options: ['🐴', '🐮', '🫏'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'فيل', answer: '🐘', options: ['🐘', '🦒', '🐪'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'ذئب', answer: '🐺', options: ['🐺', '🐶', '🦊'] },
  ...
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'ديك', answer: '🐓', options: ['🐓', '🦆', '🐦'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'ضفدع', answer: '🐸', options: ['🐸', '🦆', '🐬'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'بومة', answer: '🦉', options: ['🦉', '🦅', '🐦'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'نسر', answer: '🦅', options: ['🦅', '🦉', '🦜'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'ببغاء', answer: '🦜', options: ['🦜', '🐦', '🕊️'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'حوت', answer: '🐋', options: ['🐋', '🐬', '🐸'] },
  { question: "ما هو الحيوان الذي يصدر هذا الصوت؟", soundType: 'animal', soundKey: 'نحلة', answer: '🐝', options: ['🐝', '🦗', '🐦'] },
