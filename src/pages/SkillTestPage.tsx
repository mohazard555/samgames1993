...
const SKILL_TEST_QUESTIONS: SkillQuestion[] = [
  ...
  { id: 10, category: 'حيوانات', emoji: '🦁', question: 'من هو ملك الغابة في عالم الحيوانات البرية؟', options: ['النمر', 'الأسد', 'الفيل', 'الدب'], correctAnswer: 'الأسد', explanation: 'يُلقب الأسد بملك الغابة لقوته ושجاعته.' },
  ...
  { id: 13, category: 'علوم', emoji: '🌱', question: 'ماذا تحتاج النبتة الصغيرة لكي تنمو وتكبر؟', options: ['ماء وضوء شمس وتربة', 'ظلام تام ومواد بلاستيكية', 'سكر وثلج', 'حديد وصخور'], correctAnswer: 'ماء وضوء شمس وتربة', explanation: 'النباتات الحية تحتاج للماء والشمس والتربة والغذاء لتنمو.' },
  ...
  { id: 38, category: 'جغرافيا', emoji: '⛰️', question: 'ما هو أعلى جبل في العالم أجمع؟', options: ['جبل إيفرست', 'جبل طارق', 'جبل أوهود', 'جبل الHimalaya'], correctAnswer: 'جبل إيفرست', explanation: 'قمة إيفرست هي أعلى قمة جبلية على وجه الأرض.' },
